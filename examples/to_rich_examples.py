...
def demo_background_gradients(df, console):
    ...
    console.print(df.head(4).pirr.to_rich(
        bg="coolwarm", 
...
def demo_header_styling(df, series, console):
    ...
    console.print(series.head(4).pirr.to_rich(
...
def demo_alternating_rows(df, console):
    ...
    console.print(df.head(6).pirr.to_rich(
...
def demo_complex_combinations(df, console):
    ...
    console.print(df.head(5).pirr.to_rich(
        bg="viridis",
        tg="plasma", 
...
def main():
    ...
    console.print("[bold green]🎨 PIRRTOOLS TO_RICH COMPREHENSIVE EXAMPLES[/bold green]")
