...
class ToRichTutor:
    ...
    def lesson_1_basic_usage(self):
        ...
        self.show_code_example(
            "df.pirr.to_rich()",
            "Convert DataFrame to Rich table with default styling"
        )
        ...
        # With title
        self.show_code_example(
            'df.pirr.to_rich(title="Sales Report")',
    ...
    def lesson_2_background_gradients(self):
        ...
        self.show_code_example(
            ...
            "Apply default background gradient"
        )
        ...
        for cmap in colormaps:
            self.show_code_example(
                f'df.pirr.to_rich(bg="{cmap}")',
                f"Using {cmap} colormap"
            )
    ...
    def lesson_3_text_gradients(self):
        ...
        for cmap in text_cmaps:
            self.show_code_example(
                f'df.pirr.to_rich(tg="{cmap}")',
                f"Text gradient with {cmap} colormap"
            )
    ...
    def lesson_4_header_styling(self):
        ...
        header_table = self.sample_df.pirr.to_rich(column_header_style="bold white on blue")
        ...
        self.show_code_example(
            'df.pirr.to_rich(index_bg="coolwarm")',
            "Apply background gradient to index"
        )
